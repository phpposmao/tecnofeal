            ...
            <section className="w-full max-w-sm">
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-center mb-6">
                        <h2 className="text-3xl font-black text-primary-dark-grey">Matheus Murgel</h2>
                        <h3 className="text-2xl font-semibold text-gray-600">Administrativo</h3>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <a href="mailto:matheus.murgel@tecnofeal.com.br">
                            <button className="btn-card flex justify-center items-center">
