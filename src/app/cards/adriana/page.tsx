            ...
            <section className="w-full max-w-sm">
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-center mb-6">
                        <h2 className="text-3xl font-black text-primary-dark-grey">Adriana Panzoldo</h2>
                        <h3 className="text-2xl font-semibold text-gray-600">Diretora Comercial</h3>
                    </div>

                    {/* Botões */}
                    <div className="flex flex-col gap-4 w-full">
                        <a href="https://web.whatsapp.com/send?phone=5511992551768">
                            <button className="btn-card flex justify-center items-center">
                                <WhatsappSvg className="m-2"/>
                                Whatsapp
                            </button>
                        </a>
                        <a href="mailto:adriana.panzoldo@tecnofeal.com.br">
                            <button className="btn-card flex justify-center items-center">
                                <EmailSvg className="m-2"/>
                                e-mail
                            </button>
                        </a>
                        <a href="tel:5530820322">
                            <button className="btn-card flex justify-center items-center">
